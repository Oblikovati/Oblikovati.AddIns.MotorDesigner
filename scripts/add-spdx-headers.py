...
This is the oblikovati-motor-designer add-in (module oblikovati.org/motor-designer),
...
pulled in solely by the designer<->host integration tests. The repo is GPL-2.0-only
